...
kafkaTopicKittiDatasetRequest = os.getenv('KAFKA_TOPIC_KITTIDATASETREQUEST','send_kitti_dataset_request')
...
for event in consumer:
  ...
  # Do whatever you want
    ...
    basedirectory=kittyextractdir+datasetname+'/'+daydir+'/'+datasetname+'/'
    ...
    kafkaSendFiles(directories, files, basicmetadata, df_merged, producer, kafkaTopicSendFiles)